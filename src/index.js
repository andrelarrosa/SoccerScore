...
async function resultadoJogo(){
    ...
    var yourTeam = readline.question("Informe o time que você quer obter informações: ")
    ...
    if(yourTeam.toUpperCase == opposingTeam.toUpperCase){
        const team = await page.evaluate(()=>{
            var a = document.querySelector(".ellipsisize.liveresults-sports-immersive__team-name-width.kno-fb-ctx span").innerHTML
            return a 
        })
        yourTeam = team
    }
